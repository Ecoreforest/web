...
export default function HojaRutaHero() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          El camino,{' '}
          <span className="italic-display font-normal">mes a mes.</span>
        </motion.h1>
        ...
        >
          De la presentación del expediente al primer bosque en pie. Tres
          fases, cinco años, una secuencia honesta sobre lo confirmado, lo
          objetivo y lo condicional.
        </motion.p>
      </motion.div>
    </section>
  );
