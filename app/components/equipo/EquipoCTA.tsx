...
export default function EquipoCTA() {
  return (
    <section className="relative bg-ink text-bone overflow-hidden grain">
      <div className="container-x max-w-5xl mx-auto py-24 lg:py-36 text-center">
        ...
        >
          Voluntariado experto · colaboraciones profesionales · contrataciones futuras
        </motion.p>
        ...
        >
          ...
          <span className="italic-display font-normal text-bone">primer capítulo?</span>
        </motion.h2>
        ...
        >
          Si tienes experiencia en ingeniería forestal, gestión de residuos,
          comunicación ambiental, derecho del tercer sector o cualquier
          disciplina que pueda sumar, hablemos. El equipo crece con el
          proyecto.
        </motion.p>
