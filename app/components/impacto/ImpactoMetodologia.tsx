...
/**
 * Paso 13: indicador "Volumen de compost producido" pasa a "Compost
 * aplicado en parcela + validación de lote entrante" (reflejo real de
 * lo que hacemos, no de lo que producimos).
 */
...
const indicadores = [
  ...
  {
    indicador: 'Validación de compost entrante',
    metodo: 'Análisis fisicoquímico independiente por lote (partner UNE 142500)',
    frecuencia: 'Por lote',
  },
  {
    indicador: 'Compost aplicado en parcela',
    metodo: 'Registro de aplicación por parcela + trazabilidad al lote',
