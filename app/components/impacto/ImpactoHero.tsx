    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          className="text-display-lg font-semibold text-bone tracking-tight max-w-[22ch] text-balance"
        >
          Lo que medimos.{' '}
          <span className="italic-display font-normal">Lo que reportamos.</span>
        </motion.h1>
        ...
        >
          Aún no hemos plantado el primer árbol. Pero ya hemos decidido qué vamos
          a medir, con qué herramientas y a quién se lo vamos a contar.
        </motion.p>
      </motion.div>
    </section>
  );
