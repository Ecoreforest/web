...
/**
 * Paso 13: métricas actualizadas tras externalización compost.
 * "70 kt Compost certificado/año" (que sonaba a producción propia) pasa
 * a "Compost UNE 142500 validado" con foco en aseguramiento de calidad
 * (partners) en lugar de volumen producido.
 */
...
const metricas = [
  ...
  },
  {
    valor: 5,
    suffix: '',
    label: 'Productores partner UNE 142500',
    contexto: 'Red de proveedores auditados · compost validado por lote',
  },
  {
    valor: 18,
    suffix: ' kt',
  ...
  },
  {
    valor: 100,
    suffix: '%',
    label: 'Compost analizado por lote',
    contexto: 'Análisis fisicoquímico independiente antes de aplicar',
  },
  {
    valor: 4,
    suffix: '',
